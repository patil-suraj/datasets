...
"""Europarl: A parallel corpus extracted from the European Parliament"""
...
_HOMEPAGE = "http://opus.nlpl.eu/Europarl.php"
...
_BASE_URL = "http://opus.nlpl.eu/download.php?f=Europarl/v8/moses"
    ...
    def _split_generators(self, dl_manager):
        ...
        return [
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    "source_file": os.path.join(data_dir, f"Europarl.{self.config.name}.{lang_pair[0]}"),
                    "target_file": os.path.join(data_dir, f"Europarl.{self.config.name}.{lang_pair[1]}"),
                },
            ),
        ]
